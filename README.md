GDP per capita figures based on purchasing power parity for selected countries and region. Data is based on [The World Bank](https://data.worldbank.org/indicator/NY.GDP.PCAP.PP.CD).
